...
#ifndef GCC_GIMPLE_PRETTY_PRINT_CUSTOM_H
#define GCC_GIMPLE_PRETTY_PRINT_CUSTOM_H

#include "tree-pretty-print.h"

/* In gimple-pretty-print.c  */
extern void debug_gimple_stmt_custom (gimple *);
extern void debug_gimple_seq (gimple_seq);
extern void print_gimple_seq_custom (FILE *, gimple_seq, int, dump_flags_t);

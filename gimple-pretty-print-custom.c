...
#include "ssa.h"
#include "cgraph.h"
#include "gimple-pretty-print-custom.h"
...
DEBUG_FUNCTION void
debug_gimple_stmt_custom (gimple *gs)
{
...
/* Print GIMPLE statement G to FILE using SPC indenstation spaces and
...
{
  print_gimple_seq_custom (stderr, seq, 0, TDF_VOPS|TDF_MEMSYMS);
}
